...
/// 
/// Сам тег [ruby] выступает контейнером для тега [rt], он и формирует аннотацию к тексту, после которого идет; а также <c>rp</c>, этот тег предназначен для браузеров, которые не поддерживают [ruby].
/// 
